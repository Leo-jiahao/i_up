...
/** @defgroup  bspatch Private TypesDefinitions 私有类型
  * @{
  */
...
/**
  * @}
  */
/** @defgroup  bspatch Private Defines 私有宏定义
  * @{
  */
...
/** @defgroup bspatch Private Macros 私有宏指令
  * @{
  */
...
/**
  * @}
  */
 /** @defgroup bspatch Private Variables 私有变量
  * @{
  */
 /**
  * @}
...
/** @defgroup  bspatch Private FunctionPrototypes 私有函数
  * @{
  */
 /**
  * @}
  */
/** @defgroup  bspatch  Public Functions 共有函数
  * @{
  */
/**
