...
/** @defgroup  bitio Private TypesDefinitions 私有类型
  * @{
  */
...
/** @defgroup bitio Private Macros 私有宏指令
  * @{
  */
...
/**
  * @}
  */
 /** @defgroup bitio Private Variables 私有变量
  * @{
  */
 /**
  * @}
...
/** @defgroup  bitio Private FunctionPrototypes 私有函数
  * @{
  */
 /**
  * @}
...
//  * @param len 
//  */
// void buf_read(bFile_t *bf,uint8_t * dest, int len)
// {
//   uint32_t len_=0;
//   if(bf->filesize - bf->seek > len){
//     len_ = len;
//   }else{
//     len_ = bf->filesize - bf->seek;
//   }
  
//   for(int i = 0; i < len_; i++){
//     dest[i] = READ_U8(bf->file_addr + bf->seek +i);
//   }
//   bf->read = len_;
//   if(len_==0){
//     return;
